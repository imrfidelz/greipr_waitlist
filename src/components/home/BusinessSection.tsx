          ...
          <div className="animate-fade-in order-1 lg:order-2">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {resources.map((resource, index) => (
                <Card 
                  key={resource.title} 
                  className="group hover:shadow-warm transition-all .animate-on-scroll duration-300 border-glass hover:border-primary/30 backdrop-blur-glass bg-glass/50 hover:bg-glass/70 hover:scale-105"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <CardHeader className="pb-3">
                    <div className="w-12 h-12 mb-3 rounded-lg bg-primary flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
